...
**Image Path**: `public.ecr.aws/your-alias/solr`
...
```bash
docker pull public.ecr.aws/your-alias/solr:solr
```
```bash
docker pull public.ecr.aws/your-alias/solr:container
```
```bash
docker pull public.ecr.aws/your-alias/solr:enterprise
```
...
```bash
docker run -it --name solr public.ecr.aws/your-alias/solr:latest
```
...
docker run -d --name solr-prod \
  ...
  public.ecr.aws/your-alias/solr:latest
```

Volume Mount Mount local directory for persistent data

```bash
docker run -v /app:/app public.ecr.aws/your-alias/solr:latest
```

Port Forwarding Run with custom port mappings

```bash
docker run -p 8080:8080 public.ecr.aws/your-alias/solr:latest
```
